                        ...
                        <div slot="body">
                            <div class="control-group"
                                ...
                                <input type="text" class="control" name="{{$locale}}[page_title]"
                                       ...
                                       readonly data-vv-as="&quot;{{ __('admin::app.cms.pages.page-title') }}&quot;">
                            ...
                            <div class="control-group">
                                ...
                                <input type="text" class="control" name="homeHeading"
                                       value="{{$decoded_content->homeHeading ?? ''}}">
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="img-upload ml-3">
                                    <div id="image-preview-1" class="img-preview">
                                        <img id="preview-1"
                                             src="{{optional($page->getMedia('logo')->first())->getUrl()}}"
                                             alt="Preview">
                                    ...
                                    <div id="image-preview-2" class="img-preview">
                                        @if($page->hasMedia('slider_image1'))
                                            <video width="400" controls>
                                                <source
                                                    src="{{optional($page->getMedia('slider_image1')->first())->getUrl()}}"
                                                    id="video_here">
                                                @else
                            ...
                            <div class="control-group">
                                ...
                                <input type="text" class="control" name="sliderHeading0"
                                       value="{{$decoded_content->sliderHeading0 ?? ''}}">
                            </div>
                                ...
                                <div class="img-upload ml-3">
                                    <div id="image-preview-3" class="img-preview">
                                        @if($page->hasMedia('slider_image2'))
                                            <video width="400" controls>
                                                <source
                                                    src="{{optional($page->getMedia('slider_image2')->first())->getUrl()}}"
                                                    id="video_here1">
                                                @else
                                                    <p>No Video Selected</p>
                                            </video>
                            ...
                            <div class="control-group" :class="[errors.has('sliderHeading1') ? 'has-error' : '']">
                                ...
                                <input type="text" class="control" name="sliderHeading1"
                                       value="{{$decoded_content->sliderHeading1 ?? ''}}">
                            </div>
                            <div class="control-group" :class="[errors.has('sliderDes1') ? 'has-error' : '']">
                                ...
                                <input type="text" class="control" id="content" name="sliderDes1"
                                       value="{{$decoded_content->sliderDes1 ?? ''}}">
                            </div>
                            <div class="control-group">
                                ...
                                <div class="img-upload ml-4">
                                    <div id="image-preview-4" class="img-preview">
                                        <img id="preview-4"
                                             src="{{optional($page->getMedia('slider_image3')->first())->getUrl()}}"
                                             alt="Preview">
                            ...
                            <div class="control-group" :class="[errors.has('sliderHeading2') ? 'has-error' : '']">
                                ...
                                <input type="text" class="control" id="content" name="sliderHeading2"
                                       value="{{$decoded_content->sliderHeading2 ?? ''}}">
                            </div>
                            <div class="control-group" :class="[errors.has('sliderDes2') ? 'has-error' : '']">
                                ...
                                <input type="text" class="control" id="content" name="sliderDes2"
                                       value="{{$decoded_content->sliderDes2 ?? ''}}">
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <textarea type="text" class="control" id="content"
                                          name="content">{{$decoded_content->content ?? ''}}</textarea>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="img-upload ml-5">
                                    <div id="image-preview-5" class="img-preview">
                                        <img id="preview-5"
                                             src="{{optional($page->getMedia('info_image1')->first())->getUrl()}}"
                                             alt="Preview">
                            ...
                            <div class="control-group" :class="[errors.has('infoHeading0') ? 'has-error' : '']">
                                ...
                                <input type="text" class="control" id="content" name="infoHeading0"
                                       value="{{$decoded_content->infoHeading0 ?? ''}}">
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="img-upload ml-6">
                                    <div id="image-preview-6" class="img-preview">
                                        <img id="preview-6"
                                             src="{{optional($page->getMedia('info_image2')->first())->getUrl()}}"
                                             alt="Preview">
                            ...
                            <div class="control-group" :class="[errors.has('infoHeading1') ? 'has-error' : '']">
                                ...
                                <input type="text" class="control" id="content" name="infoHeading1"
                                       value="{{$decoded_content->infoHeading1 ?? ''}}">
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="img-upload ml-7">
                                    <div id="image-preview-7" class="img-preview">
                                        <img id="preview-7"
                                             src="{{optional($page->getMedia('info_image3')->first())->getUrl()}}"
                                             alt="Preview">
                            ...
                            <div class="control-group" :class="[errors.has('infoHeading2') ? 'has-error' : '']">
                                ...
                                <input type="text" class="control" id="content" name="infoHeading2"
                                       value="{{$decoded_content->infoHeading2 ?? ''}}">
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="img-upload ml-8">
                                    <div id="image-preview-8" class="img-preview">
                                        <img id="preview-8"
                                             src="{{optional($page->getMedia('info_image4')->first())->getUrl()}}"
                                             alt="Preview">
                            ...
                            <div class="control-group" :class="[errors.has('infoHeading3') ? 'has-error' : '']">
                                ...
                                <input type="text" class="control" id="content" name="infoHeading3"
                                       value="{{$decoded_content->infoHeading3 ?? ''}}">
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="img-upload ml-9">
                                    <div id="image-preview-9" class="img-preview">
                                        <img id="preview-9"
                                             src="{{optional($page->getMedia('info_image5')->first())->getUrl()}}"
                                             alt="Preview">
                            ...
                            <div class="control-group" :class="[errors.has('infoHeading4') ? 'has-error' : '']">
                                ...
                                <input type="text" class="control" id="content" name="infoHeading4"
                                       value="{{$decoded_content->infoHeading4 ?? ''}}">
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <input type="text" class="control" name="aboutHeading"
                                       value="{{$decoded_content->aboutHeading ?? ''}}">
                            </div>

                            <div class="control-group">
                                <label for="html_content">About Section First Description</label>
                                <textarea type="text" class="control" id="content"
                                          name="about_sec_des">{{$decoded_content->about_sec_des ?? ''}}</textarea>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="img-upload ml-10">
                                    <div id="image-preview-10" class="img-preview">
                                        <img id="preview-10"
                                             src="{{optional($page->getMedia('about_Section_Image1')->first())->getUrl()}}"
                                             alt="Preview">
                            ...
                            <div class="control-group">
                                ...
                                <textarea type="text" class="control" id="content"
                                          name="about_sec_des2">{{$decoded_content->about_sec_des2 ?? ''}}</textarea>
                            </div>
                            ...
                            <div class="control-group" :class="[errors.has('aboutHeading1') ? 'has-error' : '']">
                                ...
                                <input type="text" class="control" name="aboutHeading1"
                                       value="{{$decoded_content->aboutHeading1 ?? ''}}">
                            ...
                            <div class="control-group">
                                ...
                                <textarea type="text" class="control" id="content"
                                          name="about_sec_des3">{{$decoded_content->about_sec_des3 ?? ''}}</textarea>
                            ...
                            <div class="control-group" :class="[errors.has('aboutHeading2') ? 'has-error' : '']">
                                <label for="html_content">Heading</label>
                                <input type="text" class="control" name="aboutHeading2"
                                       value="{{$decoded_content->aboutHeading2 ?? ''}}">
                            </div>

                            <div class="control-group">
                                <label for="html_content">Description</label>
                                <textarea type="text" class="control" id="content"
                                          name="about_sec_des4">{{$decoded_content->about_sec_des4 ?? ''}}</textarea>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="img-upload ml-11">
                                    <div id="image-preview-11" class="img-preview">
                                        <img id="preview-11"
                                             src="{{optional($page->getMedia('about_Section_Image2')->first())->getUrl()}}"
                                             alt="Preview">
                            ...
                            <div class="control-group" :class="[errors.has('aboutHeading3') ? 'has-error' : '']">
                                <label for="html_content">Heading</label>
                                <input type="text" class="control" name="aboutHeading3"
                                       value="{{$decoded_content->aboutHeading3 ?? ''}}">
                            ...
                            <div class="control-group">
                                <label for="html_content">Description</label>
                                <textarea type="text" class="control" id="content"
                                          name="about_sec_des5">{{$decoded_content->about_sec_des5 ?? ''}}</textarea>
                            ...
                            <div class="control-group" :class="[errors.has('aboutHeading4') ? 'has-error' : '']">
                                <label for="html_content">Heading</label>
                                <input type="text" class="control" name="aboutHeading4"
                                       value="{{$decoded_content->aboutHeading4 ?? ''}}">
                            ...
                            <div class="control-group">
                                <label for="html_content">Description</label>
                                <textarea type="text" class="control" id="content"
                                          name="about_sec_des6">{{$decoded_content->about_sec_des6 ?? ''}}</textarea>
                            ...
                            <div class="control-group">
                                ...
                                <div class="img-upload ml-12">
                                    <div id="image-preview-12" class="img-preview">
                                        <img id="preview-12"
                                             src="{{optional($page->getMedia('about_Section_Image3')->first())->getUrl()}}"
                                             alt="Preview">
                            ...
                            <div class="control-group" :class="[errors.has('newsTitle') ? 'has-error' : '']">
                                <label for="html_content">Heading</label>
                                <input type="text" class="control" name="newsTitle" value="{{$decoded_content->newsTitle ?? ''}}">
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="img-upload ml-13">
                                    <div id="image-preview-13" class="img-preview">
                                        <img id="preview-13" src="{{optional($page->getMedia('news_Image')->first())->getUrl()}}" alt="Preview" style="display:none;">
                            ...
                            <div class="control-group">
                                ...
                                <input type="text" class="control" name="footerHeading"
                                       value="{{$decoded_content->footerHeading ?? ''}}">
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <input type="text" id="icons" class="control" name="phoneIcon"
                                       ...
                                       value="{{$decoded_content->phoneIcon ?? ''}}">
                            </div>
                            ...
                            <div class="control-group" :class="[errors.has('trollNum') ? 'has-error' : '']">
                                ...
                                <input type="text" class="control" name="trollNum"
                                       placeholder="{{ __('Troll-Free Number') }}"
                                       value="{{$decoded_content->trollNum ?? ''}}">
                            </div>
                            ...
                            <div class="control-group" :class="[errors.has('localNum') ? 'has-error' : '']">
                                ...
                                <input type="text" class="control" name="localNum"
                                       ...
                                       value="{{$decoded_content->localNum ?? ''}}">
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <input type="text" id="icons" class="control" name="emailIcon"
                                       ...
                                       value="{{$decoded_content->emailIcon ?? ''}}">
                            </div>

                            <div class="control-group" :class="[errors.has('email') ? 'has-error' : '']">
                                <label for="html_content">Email</label>
                                <input type="email" class="control" name="email" placeholder="{{ __('Email') }}"
                                       value="{{$decoded_content->email ?? ''}}">
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <input type="text" id="icons" class="control" name="addIcon"
                                       ...
                                       value="{{$decoded_content->addIcon ?? ''}}">
                            </div>

                            <div class="control-group" :class="[errors.has('address') ? 'has-error' : '']">
                                <label for="html_content">Address</label>
                                <input type="text" class="control" name="address" placeholder="{{ __('Address') }}"
                                       value="{{$decoded_content->address ?? ''}}">
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <input type="text" id="icons" class="control" name="faceIcon"
                                       ...
                                       value="{{$decoded_content->faceIcon ?? ''}}">
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <input type="url" class="control" name="faceLink"
                                       ...
                                       value="{{$decoded_content->faceLink ?? ''}}">
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <input type="text" id="icons" class="control" name="instaIcon"
                                       placeholder="{{ __('Address Icon') }}"
                                       value="{{$decoded_content->instaIcon ?? ''}}">
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <input type="url" class="control" name="instaLink"
                                       ...
                                       value="{{$decoded_content->instaLink ?? ''}}">
                            </div>
