...
<section class="brakeSec">
    <div class="container-fluid">
        ...
        <div class="row align-items-center gap">
            <div class="col-12">
                <div class="brakeContent">
                    <h3>Performance and Wear Data</h3>
                    <p>
                        TorqStop™ Premium Air Disc Brake Pads provide performance and wear
                        characteristics that equal or exceed that of top OEM and premium aftermarket brands.
                    </p>
                </div>
            </div>
            <div class="col-md-6">
                <figure>
                    <img class="img-fluid w-100" src="{{asset('themes/default/assets/images/brake/stats2.png')}}" alt="">
                </figure>
            </div>
            <div class="col-md-6">
                <div class="brakeContent">
            ...
            <div class="col-md-6">
                <div class="brakeContent">
                    <p>
                        Not only do TorqStop™ pads last significantly longer, they offer exceptional performance. Our
                        pads provide reliable stopping power up to the highest highway speeds. The adjacent graph shows
                        how TorqStop™ pads perform equal to or better than these top competitors at 70 MPH.
                    </p>
                </div>
            </div>
            <div class="col-md-6">
                <figure>
                    <img class="img-fluid w-100" src="{{asset('themes/default/assets/images/brake/stats4.png')}}" alt="">
                </figure>
            </div>
            <div class="col-md-6">
                <figure>
                    <img class="img-fluid w-100" src="{{asset('themes/default/assets/images/brake/stats5.png')}}" alt="">
                </figure>
            </div>
            <div class="col-md-6">
                <div class="brakeContent">
                    <p>
                        Stopping distance doesn’t tell the whole story. Our proprietary burnishing strips ensure optimal
                        performance and negligible fade from the very first stop right out of the box.
                    </p>
                </div>
            </div>
            <div class="col-md-6">
                <figure>
                    <img class="img-fluid w-100" src="{{asset('themes/default/assets/images/brake/stats3.png')}}" alt="">
                </figure>
            </div>
            <div class="col-md-6">
                <div class="brakeContent">
                    <p>
                        Our highly stable friction formulation provides optimal sustained torque for reliable stopping
                        power long after break-in and throughout the life of the pad.
                    </p>
                </div>
            </div>
            <div class="col-md-6">
                <div class="brakeContent">
                    <p>
                        TorqStop™ brake pad’s retardation ratio aligns most closely with FMVSS121 specifications versus
                        its competitors.
                    </p>
                    <p>
                        FROM THE DRIVER’S SEAT, this means that TorqStop™ pads deliver more consistent, linear braking
                        output in relation to increases in pedal pressure. This provides enhanced driver control, pedal
                        feel, and feedback. Some competitive pads tend to increase retardation more quickly with
                        increases in pedal pressure, which creates an over-sensitive pedal feel which can lead to
                        over-braking, unwanted ABS events, or loss of control. Also, worth noting is one of the
            ...
            <div class="col-md-6">
                <figure>
                    <img class="img-fluid w-100" src="{{asset('themes/default/assets/images/brake/mainState1.png')}}" alt="">
                </figure>
            </div>
            <div class="col-md-6">
                <figure>
                    <img class="img-fluid w-100" src="{{asset('themes/default/assets/images/brake/mainState2.png')}}" alt="">
                </figure>
            </div>
            <div class="col-md-6">
                <div class="brakeContent">
                    <p>
                        As shown in this illustration, TorqStop™ Brake Pads provide reliable stopping power even after
                        multiple stops in close succession. Pedal pressure varies minimally (less than 9 lbf / sq in)
                        during a 10 brake stop test. This indicates very low fade and consistent pedal input stop after
                        stop.
                    </p>
                </div>
            </div>
