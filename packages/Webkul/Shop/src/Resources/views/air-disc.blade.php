...
{{--                    <h2>Air Brake Calipers</h2>--}}
                    ...
                    <ul>
                        <li>
                            ...
                            <h4>100% brand new castings & internal components.<br>NO CORE LIABILITY TO TIE UP YOUR
                                CASH!</h4>
                        </li>
                        <li>
                            <i class="fas fa-check-circle"></i>
                            All calipers sold as complete assemblies with carriers
                        </li>
                        <li>
                            <i class="fas fa-check-circle"></i>
                        ...
                        <li>
                            <i class="fas fa-check-circle"></i>
                            Vertically integrated manufacturing capabilities for complete control of all processes
                            from
                            forging, cold extrusion, heat treatment, CNC machining, automatic assembly and final
                            testing ensured the highest-grade casting metallurgy for optimal longevity and
                            performance.
                        </li>
                        <li>
                            <i class="fas fa-check-circle"></i>
                            Exceeds FMVSS121 performance standards
                        </li>
                        <li>
                            <i class="fas fa-check-circle"></i>
                            Extensively tested for compliance with dimensional and performance specifications by
                            US-based quality control engineers
                        </li>
                        <li>
                            <i class="fas fa-check-circle"></i>
                            Corrosion-resistant guide pins
                        </li>
                        <li>
                            <i class="fas fa-check-circle"></i>
                            Proprietary silicone seal designs that withstand both high and low temperature extremes
                        </li>
                        <li>
                            <i class="fas fa-check-circle"></i>
                            High-temperature anti-seizing grease for longlasting smooth operation .
                        </li>
                        <li>
                            <i class="fas fa-check-circle"></i>
                            100% Production line testing for precise functionality of all critical force and torque
                            specifications
                        </li>
                        <li>
                            <i class="fas fa-check-circle"></i>
                            Upgraded adjuster mechanisms to prevent under and over adjustment that could lead to
