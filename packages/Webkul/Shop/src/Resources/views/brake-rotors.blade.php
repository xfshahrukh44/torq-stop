    ...
    <div class="container-fluid">
            ...
            <div class="col-md-6">
                <div class="brakeContent">
                    ...
                    <p>
                        ...
                        TorqStop™ offers OEM-quality medium and heavy-duty rotors for commercial truck and trailer,
                        transit, defense, emergency and off-highway applications.
                    </p>
                    <ul>
                        <li>
                            <i class="fas fa-check-circle"></i>
                            Our comprehensive lineup of “Flat”, “U”, and “Hat” rotors covers most major air disc
                            brake systems from Bendix®, Knorr-Bremse®, Meritor®, WABCO®, Hendrickson®, and Haldex®.
                        </li>
                        <li>
                            <i class="fas fa-check-circle"></i>
                            Developed and manufactured under IATF 16949:2016 standards
                        </li>
                        <li>
                            <i class="fas fa-check-circle"></i>
                            Cast from premium raw materials for clean, consistent, high-grade iron
                        </li>
                        <li>
                            <i class="fas fa-check-circle"></i>
                            Molded and machined to deliver uniformity, precision, and superior surface finish
                        </li>
                        <li>
                            <i class="fas fa-check-circle"></i>
                            OE cooling fin designs ensure proper heat dissipation and minimize harmonic vibration
                        </li>
                        <li>
                            <i class="fas fa-check-circle"></i>
                            Mounting bolts, hardware, and ABS rings included where applicable
                        </li>
                        <li>
                            <i class="fas fa-check-circle"></i>
                            Tested to meet stringent durability standards OEMquality high-grade G3000 metallurgy
                        </li>
                        <li>
                            <i class="fas fa-check-circle"></i>
                            Parallelism tolerance: (Microns): 0.1mm
                        </li>
                        <li>
                            <i class="fas fa-check-circle"></i>
                            Runout tolerance: (Microns): 0.15mm
                        </li>
                        <li>
                            <i class="fas fa-check-circle"></i>
                            DTV tolerance (Microns): 0.013mm
                        </li>
                        <li>
                            <i class="fas fa-check-circle"></i>
                            Surface finish specs: (Microns): Straddle-cut, 1µm
                        </li>
                        <li>
                            <i class="fas fa-check-circle"></i>
                            Balance tolerance: 2300g/cm
                        </li>
                        <li>
                            <i class="fas fa-check-circle"></i>
                            Zinc-Aluminum coating, exceeds 72-hour salt spray tests
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="brakeImg">
                    <figure>
                        <img src="{{asset('themes/default/assets/images/brake/spec1.png')}}" alt="">
                    </figure>
                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <tr>
                            <th>TORQSTOP™ PART NO.</th>
                            <th>ROTOR TYPE</th>
                            <th>OVERALL DIA. (IN)</th>
                            <th>DISC THICKNESS (IN)</th>
                            <th>OVERALL DEPTH (IN)</th>
                            <th>PILOT DIA.(IN)</th>
                            <th>BOLT CIRCLE DIA.(IN)</th>
                            <th>BOLT HOLE DIA.</th>
                            <th>BOLT HOLE NO.</th>
                            <th>ABS TONE RING</th>
                        </tr>
