...
<section class="brakeSec">
    <div class="container-fluid">
                ...
                <div class="table-responsive">
                    <table>
                        ...
                        @for($i=1;$i<=4;$i++)
                            <tr>
                                <td>KB001</td>
                                <td>ADB22x, LT, SK7, ST7</td>
                                <td>Guide pin replacement Kit for ADB22x, ADB22xLT, SK7 caliper</td>
                                <td>
                                    <fiugre class="imgBox">
                                        <img
                                            src="{{asset('themes/default/assets/images/brake/misc-brake'. $i .'.png')}}"
                                            alt="">
                                    </fiugre>
                                </td>
                            </tr>
        ...
        <div class="row">
            <div class="col-12">
                <div class="brakeContent">
                    <h3>Air Disc Service Parts and Hardware</h3>
                </div>
                <div class="table-responsive">
                    <table>
                        <thead>
                        ...
                        @for($i=1;$i<=4;$i++)
                            <tr>
                                ...
                                <td>
                                    <fiugre class="imgBox">
                                        <img src="{{asset('themes/default/assets/images/brake/misc-disc'. $i .'.png')}}"
                                             alt="">
                                    </fiugre>
                                </td>
                            </tr>
