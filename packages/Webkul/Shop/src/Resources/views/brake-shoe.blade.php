...
{{--                    <h2>Drum Brake Shoes with Hardware</h2>--}}
                    <h3>Features and Benefits</h3>
                    <ul>
                        <li>
                            <i class="fas fa-check-circle"></i>
                            <h4>100% new. No more dealing with messy
                                cores!</h4>
                        </li>
                        <li>
                            <i class="fas fa-check-circle"></i>
                            Convenient stop-box contains 2 shoes and HD hardware
                        </li>
                        <li>
                            <i class="fas fa-check-circle"></i>
                            Manufactured in an IATF16949-2016 certified factory
                        </li>
                        <li>
                            <i class="fas fa-check-circle"></i>
                            Robust E-coating corrosion protection extends life and prevents rust-jacking
                        </li>
                        <li>
                            <i class="fas fa-check-circle"></i>
                        ...
                        <li>
                            <i class="fas fa-check-circle"></i>
                            All shoe tables and webs are made from heavy-gauge high grade carbon steel with tightly
                            controlled tolerances; ensuring consistent shoe-drum contact for maximum performance and
                            wear characteristics.
                        </li>
                        <li>
                            <i class="fas fa-check-circle"></i>
                            Heat-treated roller and anchor journals to prevent distortion, mushrooming and wear,
                            which is commonly found with relined shoes.
                        </li>
                        <li>
                            <i class="fas fa-check-circle"></i>
                            Quality Components – our hardware kits contain heavy-duty springs, stainless steel
                            bushings, heat treated and zinc chromate coated rollers and powder-coated springs,
                            designed to be rust resistant and improve the dependability of your brakes
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <p>Meritor &ldquo;Q&rdquo; First Design</p>
                            </td>
                            <td>
                                <p>23k</p>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <p>Meritor &ldquo;Q&rdquo; with Relocated Spring Hole</p>
                            </td>
                            <td>
                                <p>23k</p>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <p>Dexter PQ Style (Open / closed)</p>
                            </td>
                            <td>
                                <p>23k</p>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <p>Dana Spicer &ldquo;Fast Change&rdquo; II (Open / Open)</p>
                            </td>
                            <td>
                                <p>23k</p>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <p>Dana Spicer FC with Spring Notch (Open / Open)</p>
                            </td>
                            <td>
                                <p>23k</p>
                            </td>
